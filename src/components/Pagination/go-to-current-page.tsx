...
const GoToPageIcon = (props: IconProps) => (
  <svg {...props} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="10" cy="10" r="7.35" stroke="currentColor" strokeWidth="1.3" />
    <line
      x1="10.847"
      y1="7.38379"
      x2="13.4633"
    ...
    <line
      ...
      strokeLinecap="round"
    />
    <path d="M6.45312 10H13.4531" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" />
  </svg>
);
...
export const GoToCurrentPage = () => {
  ...
  return (
    <div className={classes.SearchPage}>
      ...
      <button
        className={cn(classes.Button, "currentButton", !value && "disabled")}
        onClick={goToCurrentPage}
      >
        <GoToPageIcon className="currentIcon" />
      </button>
    </div>
  );
};
